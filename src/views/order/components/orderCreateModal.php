...
<div class="modal fade" id="agregarOrderModal" tabindex="-1" aria-labelledby="agregarOrderModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Encabezado del modal -->
            <div class="modal-header">
                <h4 class="modal-title" id="agregarOrderModalLabel">Nueva Pedido</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <!-- Cuerpo del modal con el formulario -->
            <div class="modal-body">
                <form id="formAgregarOrder" class="needs-validation" action="" method="POST" novalidate>
                    <div class="mb-3">
