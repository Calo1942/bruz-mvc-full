...
<body>
    ...
    <div class="flex-grow-1 d-flex flex-column">
        ...
        <main class="flex-grow-1 p-4 bg-light">
            ...
            require_once 'components/orderDataTable.php';
            ?>
        </main>
        ...
        <script src="src\assets\js\order\orderConfigDatable.js"></script>
        
        <script src="src\assets\js\commons\templateDatables.js"></script>
        
        <!-- Modales -->
        <?php require_once 'components/orderCreateModal.php'; ?>
        <?php require_once 'components/orderEditModal.php'; ?>
        <?php require_once 'components/orderViewModal.php'; ?>
